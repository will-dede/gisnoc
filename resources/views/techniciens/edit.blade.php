    ...
    <div class="w-full max-w-md mx-auto mt-10">
        <form method="POST" action="{{ route('techniciens.update', $technicien) }}" class="bg-white shadow rounded p-8">
            ...
            <div>
                ...
                <x-text-input id="nom_technicien" name="nom_technicien" type="text" class="block mt-1 w-full" :value="old('nom_technicien', $technicien->nom_technicien)" required autofocus />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="prenom_technicien" name="prenom_technicien" type="text" class="block mt-1 w-full" :value="old('prenom_technicien', $technicien->prenom_technicien)" required />
            ...
            <div class="mt-4">
                ...
                <x-text-input id="tel_technicien" name="tel_technicien" type="text" class="block mt-1 w-full" :value="old('tel_technicien', $technicien->tel_technicien)" required />
