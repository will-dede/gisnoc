<x-app-layout>
    ...
    <div class="w-full max-w-md mx-auto mt-10">
        <form method="POST" action="{{ route('regions.store') }}" class="bg-white shadow rounded p-8">
            @csrf
            <h1 class="text-2xl font-bold mb-6 text-center">Ajouter une région</h1>
            @if(session('success'))
            ...
            <div>
                ...
                <x-text-input id="nom_region" name="nom_region" type="text" class="block mt-1 w-full" :value="old('nom_region')" required autofocus />
