                    ...
                    @forelse($bscs as $bsc)
                        <tr>
                            ...
                            <td class="border px-2 py-1 flex items-center justify-between">
                                <span>
                                    {{ $bsc->nom_bsc }} <span class="text-gray-500 text-sm">({{ $bsc->sites->count() }} sites affectés)</span>
                                </span>
                                <div class="text-center">
                                    <a href="{{ route('bscs.show', $bsc) }}" class="flex flex-col text-blue-600 hover:text-blue-900 mx-2">
