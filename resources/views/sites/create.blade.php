        ...
        <form method="POST" action="{{ route('sites.store') }}" class="bg-white shadow rounded p-8">
            ...
            <div class="grid grid-cols-2 gap-4 mb-6">
                <div>
                    ...
                    <select id="canal" name="canal" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                        <option value="">Sélectionner le canal</option>
                        <option value="fo" {{ old('canal') == 'fo' ? 'selected' : '' }}>Fibre optique (FO)</option>
                        <option value="fh" {{ old('canal') == 'fh' ? 'selected' : '' }}>Faisceau Hertzien (FH)</option>
                    </select>
