                ...
                <tbody>
                    ...
                    @forelse($typesSite as $type)
                        <tr>
                            ...
                            <td class="border px-2 py-1">{{ $type->nom_type_site }}  <span class="text-gray-500 text-sm">({{ $type->sites->count() }} sites affectés)</span></td>
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center py-2">Aucun node type trouvé.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
