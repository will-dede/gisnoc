        ...
        <div class="max-w-4xl mx-auto">
            ...
            <table class="min-w-full bg-white border">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-2 py-1 text-center">
                                <div class="flex space-x-4 justify-center font-bold">
                                    <a href="{{ route('typesite.show', $type) }}" class="flex flex-col items-center text-blue-600 hover:text-blue-900 mx-2">
                                        <i class="fas fa-eye text-sm"></i>
                                        <span class="text-sm">Détails</span>
                                    </a>
                                    <a href="{{ route('typesite.edit', $type) }}" class="flex flex-col items-center text-yellow-600 hover:text-yellow-900 mx-2">
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="text-center py-2">Aucun type de site trouvé.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
