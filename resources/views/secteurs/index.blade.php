                ...
                <tbody>
                    ...
                    @forelse($secteurs as $secteur)
                        <tr>
                            ...
                            <td class="border px-2 py-1">{{ $secteur->frequence->technologie->nom_technologie }}</td>
                            <td class="border px-2 py-1">{{ $secteur->frequence->nom_freq }}</td>
                            <td class="border px-2 py-1">{{ $secteur->nom_secteur }}</td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center py-2">Aucun secteur trouvé.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
