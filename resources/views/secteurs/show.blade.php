<x-app-layout>
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <div class="bg-white shadow-md rounded-lg overflow-hidden mb-8">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h1 class="text-2xl font-semibold text-gray-800">Détails du secteur</h1>
            ...
            <div class="mt-6">
                <a href="{{ route('secteurs.index') }}" class="inline-flex items-center px-1 py-1 text-blue-800 hover:bg-blue-50 rounded focus:outline-none focus:shadow-outline">
