<x-app-layout>
    <div class="w-full max-w-md mx-auto mt-10">
        <form method="POST" action="{{ route('rncs.update', $rnc) }}" class="bg-white shadow rounded p-8">
            @csrf
            @method('PUT')
            <h1 class="text-2xl font-bold mb-6 text-center">Modifier le RNC</h1>
            @if(session('success'))
            ...
            <div>
                ...
                <x-text-input id="nom_rnc" name="nom_rnc" type="text" class="block mt-1 w-full" :value="old('nom_rnc', $rnc->nom_rnc)" required autofocus />
