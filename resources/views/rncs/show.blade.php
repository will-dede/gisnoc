            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden mb-8">
                <div class="p-6">
                    ...
                    <div class="flex justify-between">
                        <div>
                            <label class="block text-sm text-gray-700">Nom du RNC</label>
                            <p class="mt-1 text-sm text-gray-900 font-bold">{{ $rnc->nom_rnc }}</p>
                        </div>
                        <div>
                            <label class="block text-sm text-gray-700">Date de création</label>
                            <p class="mt-1 text-sm text-gray-900 font-bold">{{ $rnc->created_at->format('d/m/Y H:i') }}</p>
                        </div>
                        <div>
                            <label class="block text-sm text-gray-700">Dernière modification</label>
                            <p class="mt-1 text-sm text-gray-900 font-bold">{{ $rnc->updated_at->format('d/m/Y H:i') }}</p>
                        </div>
                    </div>                    
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach($rnc->sites as $site)
                                        <tr>
                                            ...
                                            <td class="border px-2 py-1 text-sm text-center text-gray-900">{{ $site->cell3G ?? '' }}</td>
