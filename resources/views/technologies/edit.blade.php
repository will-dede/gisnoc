<x-app-layout>
    <div class="w-full max-w-md mx-auto mt-10">
        <form method="POST" action="{{ route('technologies.update', $technologie) }}" class="bg-white shadow rounded p-8">
            @csrf
            @method('PUT')
            <h1 class="text-2xl font-bold mb-6 text-center">Modifier la technologie</h1>
            @if(session('success'))
            ...
            <div>
                ...
                <x-text-input id="nom_technologie" name="nom_technologie" type="text" maxlength="15" class="block mt-1 w-full" :value="old('nom_technologie', $technologie->nom_technologie)" required autofocus />
